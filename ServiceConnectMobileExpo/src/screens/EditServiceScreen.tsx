                    ...
                    <View style={styles.availabilityContainer}>
                        ...
                        <TouchableOpacity
                            style={[
                                ...
                                formData.availability ? styles.available : styles.unavailable,
                            ]}
                            onPress={() => setFormData(prev => ({ ...prev, availability: !prev.availability }))}
                        >
                            <MaterialIcons
                                name={formData.availability ? 'check-circle' : 'cancel'}
                                size={20}
                                color={formData.availability ? '#4CAF50' : '#FF9800'}
                            />
                            <Text style={styles.availabilityText}>
                                {formData.availability ? 'Đang có sẵn' : 'Tạm hết'}
                            </Text>
                        </TouchableOpacity>
                    </View>
