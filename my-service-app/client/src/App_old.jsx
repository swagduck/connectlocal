...
const Navbar = () => {
  ...
  console.log('🔔 Navbar - Friend request count:', friendRequestCount);
  console.log('🔔 Navbar - Message count:', getNotificationCount('message'));
  console.log('🔔 Navbar - Total notifications count:', notifications.length);
